            ...
            <div className='box' >
                ...
                <div className='date'>
                    {(this.state.dataList.data || []).map((item, index) => {
                        return (
                            <div key={index} onMouseOver={this.showDetail.bind(this, index)} onMouseMove={this.changeStyle.bind(this, index)} className={this.state.index === index ? 'child active' : 'child'}>
